...
public class OrderAggregate {
    ...
    @CommandHandler
    public void handle(RejectOderCommand rejectOderCommand) {
    	
    	OrderRejectedEvent orderRejectedEvent = new OrderRejectedEvent(rejectOderCommand.getOrderId(), rejectOderCommand.getReason());
